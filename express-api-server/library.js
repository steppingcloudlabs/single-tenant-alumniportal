            ...
            if (res1.data.num_items === 1) {
                try {
                    ...
                    if (res2.data.num_items === 1) {
                        try {
                            ...
                            try {
                                ...
                                if (res4.data.hasOwnProperty('id') && res4.data.hasOwnProperty('credentials')) {
                                    let payload = {
                                        'id': res4.data.id,
                                        'credentials': res4.data.credentials,
                        ...
                        let errmsg = {
                            'error': 'Service plan hdi-shared not found'
                        };
                        console.log(errmsg);
                        return errmsg;
                    }
                ...
                let errmsg = {
                    'error': 'Service offering hana not found'
                };
                console.log(errmsg);
                return errmsg;
            }
    ...
    try {
        ...
        try {
            ...
            if (res1.data.num_items === 1) {
                ...
                let errmsg = {
                    'error': 'Service binding not found for tenant ' + tenantId
                };
                console.log(errmsg);
                return errmsg;
            }
