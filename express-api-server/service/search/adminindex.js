        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const query =
					...
					FROM "${schema}"."SCLABS_ALUMNIPORTAL_USERS_USERS" as A1 WHERE CONTAINS (("USER_ID", "FIRST_NAME_PERSONAL_INFORMATION", "MIDDLE_NAME_PERSONAL_INFORMATION", "LAST_NAME_PERSONAL_INFORMATION"),'${payload.QUERY}', FUZZY(0.4)) LIMIT ${LIMIT} offset ${offset}`
    ...
    const searchUserids = ({
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let country = payload.COUNTRY == undefined ? "" : payload.COUNTRY
                const query =
                    `SELECT "ID", "USER_ID", "GENDER", "DATE_OF_BIRTH", "DATE_OF_RESIGNATION", 
                    "LAST_WORKING_DAY_AS_PER_NOTICE_PERIOD", "PERSONAL_EMAIL_ID","FIRST_NAME_PERSONAL_INFORMATION",
                    "LAST_NAME_PERSONAL_INFORMATION","MIDDLE_NAME_PERSONAL_INFORMATION","NATIONALITY_PERSONAL_INFORMATION",
                    "SALUTATION_PERSONAL_INFORMATION","CITY_ADDRESSES","PHONE_NUMBER_PHONE_INFORMATION","MANAGER_JOB_INFORMATION",
