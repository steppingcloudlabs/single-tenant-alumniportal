 ...
 */
export class PersonKeyRequestBuilder extends RequestBuilder<PersonKey> {
  /**
  ...
  getByKey(personIdExternal: string): GetByKeyRequestBuilder<PersonKey> {
    return new GetByKeyRequestBuilder(PersonKey, { personIdExternal: personIdExternal });
  }
  ...
  getAll(): GetAllRequestBuilder<PersonKey> {
    return new GetAllRequestBuilder(PersonKey);
  }
}
