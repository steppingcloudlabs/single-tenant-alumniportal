 ...
 */
export class EmpWorkPermitRequestBuilder extends RequestBuilder<EmpWorkPermit> {
  /**
  ...
  getByKey(country: string, documentNumber: string, documentType: string, userId: string): GetByKeyRequestBuilder<EmpWorkPermit> {
    return new GetByKeyRequestBuilder(EmpWorkPermit, {
      country: country,
  ...
  getAll(): GetAllRequestBuilder<EmpWorkPermit> {
    return new GetAllRequestBuilder(EmpWorkPermit);
  }
}
