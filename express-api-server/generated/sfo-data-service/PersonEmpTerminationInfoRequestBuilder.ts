 ...
 */
export class PersonEmpTerminationInfoRequestBuilder extends RequestBuilder<PersonEmpTerminationInfo> {
  /**
  ...
  getByKey(personIdExternal: string): GetByKeyRequestBuilder<PersonEmpTerminationInfo> {
    return new GetByKeyRequestBuilder(PersonEmpTerminationInfo, { personIdExternal: personIdExternal });
  }
  ...
  getAll(): GetAllRequestBuilder<PersonEmpTerminationInfo> {
    return new GetAllRequestBuilder(PersonEmpTerminationInfo);
  }
}
