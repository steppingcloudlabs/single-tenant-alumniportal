 ...
 */
export class EmpEmploymentRequestBuilder extends RequestBuilder<EmpEmployment> {
  /**
  ...
  getByKey(personIdExternal: string, userId: string): GetByKeyRequestBuilder<EmpEmployment> {
    return new GetByKeyRequestBuilder(EmpEmployment, {
  ...
  getAll(): GetAllRequestBuilder<EmpEmployment> {
    return new GetAllRequestBuilder(EmpEmployment);
  }
}
