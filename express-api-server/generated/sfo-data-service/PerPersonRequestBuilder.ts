 ...
 */
export class PerPersonRequestBuilder extends RequestBuilder<PerPerson> {
  /**
  ...
  getByKey(personIdExternal: string): GetByKeyRequestBuilder<PerPerson> {
    return new GetByKeyRequestBuilder(PerPerson, { personIdExternal: personIdExternal });
  }
  ...
  getAll(): GetAllRequestBuilder<PerPerson> {
    return new GetAllRequestBuilder(PerPerson);
  }
}
