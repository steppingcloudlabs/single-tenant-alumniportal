 ...
 */
export class PerEmergencyContactsRequestBuilder extends RequestBuilder<PerEmergencyContacts> {
  /**
  ...
  getByKey(name: string, personIdExternal: string, relationship: string): GetByKeyRequestBuilder<PerEmergencyContacts> {
    return new GetByKeyRequestBuilder(PerEmergencyContacts, {
      name: name,
  ...
  getAll(): GetAllRequestBuilder<PerEmergencyContacts> {
    return new GetAllRequestBuilder(PerEmergencyContacts);
  }
}
